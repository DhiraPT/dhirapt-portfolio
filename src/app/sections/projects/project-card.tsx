...
export const ProjectCard = ({
  ...
  return (
    <motion.div
      ...
      className={`
        group/project-card relative overflow-hidden rounded-lg shadow-md transition-all duration-300 ease-in-out
        hover:shadow-lg
    ...
    >
        ...
        {coverMediaUrl ? (
          <Image
            ...
            className={`
              ...
              group-hover/project-card:scale-110
            `}
          />
        ) : (
          <div
      ...
      <div
        className={`
          absolute inset-0 flex flex-col justify-end p-4 text-slate-100
          dark:text-slate-200
        `}
      >
        <h2
          className={`
            mb-1 transform text-2xl font-bold opacity-0 transition-all duration-300 ease-in-out
            group-hover/project-card:-translate-y-1 group-hover/project-card:opacity-100
          `}
        >
          {title}
        </h2>
