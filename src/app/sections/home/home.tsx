    ...
    >
      ...
      >
        <p className="text-4xl font-bold">
          ...
          <span
            className={`
              bg-linear-to-r from-indigo-600 to-indigo-400 bg-clip-text text-transparent
      ...
      >
        <Link href="#experience">
          <div
            className={`absolute bottom-4 left-1/2 flex -translate-x-1/2 transform cursor-pointer flex-col items-center`}
          >
            <p
              className={`
            ...
            <BsChevronDoubleDown
              className={`
                animate-bounce text-3xl text-indigo-600
                dark:text-indigo-300
              `}
            />
          </div>
